<div style="background-image: url('bg_teal.png'); background-size: cover;" class="hover:scale-101 duration-300">
<a href="/landing" class="font-tommy-bold text-3xl p-5 absolute text-purple-dark hover:underline decoration-wavy">← back</a>
<div
