<div
    class="items-center justify-center flex flex-col gap-4 w-screen h-screen bg-cover hover:scale-105 duration-300"
...
>
    ...
    <p>You'd only say some words in your dreams. SleepedIn lets you speak them out loud.</p>
